...
//       continues as long as there's data available to read from the input stream
    ...
    void arrayListPrinter(ArrayList<Device> deviceInfo) {
    ...
    public ArrayList<Device> getWebDeviceInfo() {
        return deviceInfo;
    }

    public ArrayList<Device> getStringDeviceInfo(){
        return deviceInfo;
    }
}
